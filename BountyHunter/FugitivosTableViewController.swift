...
class FugitivosTableViewController: UITableViewController {
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        let destino = segue.destinationViewController as! Capturado
        //el as capturado es nombre de la clase que sigue
        let elIndex = self.tableView.indexPathForSelectedRow
        let dictInfo = self.losFugados! [ elIndex!.row] as! Fugitive
        // el asfugitive en la siguiente clase debe tener fugitivo como la info que recibe
        destino.fugitivo = dictInfo
